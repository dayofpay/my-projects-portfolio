...
* JSON ( За parse-ване на данните от API-то на БГТОЛ)
## Линк към проекта
Тук може да разгледате проекта обстойно
...
- Проекта е създаден с цел да модифицирате WooCommerce съдържанието си изцяло чрез софтуер.
